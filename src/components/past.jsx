...
const ResponsiveBoxes = () => {
  ...
  return (
  <div className="p-8 max-w-6xl mx-auto bg-black text-white mt-12 bg1">
    ...
    <div className="flex flex-col md:flex-row gap-4 mb-4 ">
      <div className="flex-1 md:basis-2/3 bg-gray-900 p-4 md:p-8 text-white rounded-2xl type1  ">
      ...
      <div className="flex-1 md:basis-1/3 bg-gray-900 p-4 md:p-8 text-white rounded-2xl type2 ">
