...
const HeroSection = () => {
  ...
  return (
    <section className="flex w-full h-screen text-white bg-black overflow-hidden relative mt-30 bg4">
...
networking, skill-building, and real-world problem-solving.
      ...
      <div className="w-1/2 relative flex items-center justify-center  ">
        <CardSwap width={500} height={650} cardDistance={90} verticalDistance={70} delay={4000}>
          <Card>
            <div className="flex flex-col h-full w-full overflow-hidden rounded-xl type4 ">
              <img
                src={boxes[0].img}
                alt="box 0"
          ...
          <Card>
            <div className="flex flex-col h-full w-full overflow-hidden rounded-xl type5">
              <img
                src={boxes[1].img}
                alt="Innovation 2"
                className="h-3/5 w-full object-contain"
