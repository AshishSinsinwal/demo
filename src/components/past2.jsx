...
const ResponsiveBoxes2 = () => {
  ...
  return (
  <div className="p-8 max-w-6xl mx-auto bg-black text-black mt-24 bg2">
    ...
    <div className="flex flex-col md:flex-row gap-4 mb-4">
      <div className="flex-1 md:basis-2/3 bg-gray-900 p-4 md:p-12 text-white rounded-2xl first ">
        <img src={boxes[0].img} alt={boxes[0].title} className="w-full mb-12 mt-4 rounded" />
        <h2 className="text-lg font-semibold ">{boxes[0].title}</h2>
        <p>{boxes[0].desc}</p>
      </div>
      <div className="flex-1 md:basis-1/3 bg-gray-900 p-4 md:p-12 text-white rounded-2xl second">
...
<FadeContent blur={true} duration={900} easing="ease-out" initialOpacity={0}>
    ...
    <div className="flex flex-col md:flex-row gap-4">
      <div className="flex-1 md:basis-1/3 bg-gray-900 p-4 md:p-12 text-white rounded-2xl first ">
      ...
      <div className="flex-1 md:basis-2/3 bg-gray-900 p-4 md:p-12 text-white rounded-2xl second">
